...
import com.cine.cinema.dao.CategorieRepository;
import com.cine.cinema.dao.CinemaRepository;
import com.cine.cinema.dao.FilmRepository;
import com.cine.cinema.dao.PlaceRepository;
import com.cine.cinema.dao.ProjectionRepository;
import com.cine.cinema.dao.SalleRepository;
import com.cine.cinema.dao.SeanceRepository;
import com.cine.cinema.dao.TicketRepository;
import com.cine.cinema.dao.VilleRepository;
...
import com.cine.cinema.entities.Ville;
...
public class CinemaInitServiceImpl implements ICinemaInitService{
	...
	public void initVilles() {
		Stream.of("Sfax","Tunis","Nabeul","Sousse").forEach(nameVille->{
	...
	public void initCinemas() {
		...
		{
			Stream.of("UNIVERS 3D"," Le Colisée","Cine Jamil","le Palace","Alhambra")
			.forEach(nameCinema->{
	...
	public void initCategories() {
		...
		Stream.of("Humour","Kids","Fiction","Drama","Histoire").forEach(cat->{
	...
	public void initFilms() {
		...
		Stream.of("12 Homes en colaire","Forest Gump","Green Book",
				"La ligne Verte","Le Parin","Le Seigneur des anneaux")
				.forEach(titreFilm->{
					Film film = new Film();
